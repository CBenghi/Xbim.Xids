...
public class AttributeFacetDescriptionTests : BaseDescriptionTests
{
	...
	[InlineData("Status", "NOTSTARTED,STARTED,COMPLETED", "an attribute Status with value 'COMPLETED' or 'NOTSTARTED' or 'STARTED'")]
	[InlineData("Name,Description", null, "an attribute 'Description' or 'Name' with value <any>")]
	[InlineData("Name,Description", "P.*", "an attribute 'Description' or 'Name' with value matching 'P.*'", ConstraintType.Pattern)]
	[InlineData("Name,Description", "Foo", "an attribute 'Description' or 'Name' with value Foo")]
	[Theory]
	...
	[InlineData("Status", "NOTSTARTED,STARTED,COMPLETED", "with attribute Status with value 'COMPLETED' or 'NOTSTARTED' or 'STARTED'")]
	[InlineData("Name,Description", null, "with attribute 'Description' or 'Name' with value <any>")]
	[InlineData("Name,Description", "P.*", "with attribute 'Description' or 'Name' with value matching 'P.*'", ConstraintType.Pattern)]
	[InlineData("Name,Description", "Foo", "with attribute 'Description' or 'Name' with value Foo")]
	[Theory]
